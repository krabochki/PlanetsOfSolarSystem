...
begin
Image1.Picture.LoadFromFile('фотокарточки\фонннн4.bmp');
...
begin
Image1.Picture.LoadFromFile('фотокарточки\фонннн3.bmp');
...
begin
Image1.Picture.LoadFromFile('фотокарточки\фонннн2.bmp');
...
begin
  Image11.Picture.LoadFromFile('фотокарточки\praktikani\фонблонд.bmp');
...
begin
  Image12.visible:=True;
    Image11.Picture.LoadFromFile('фотокарточки\praktikani\фонкирил.bmp');
         Image12.visible:=True;
Image11.visible:=true;
Image10.visible:=False;
image1.Visible:=false;
...
begin
  Image12.visible:=True;
    Image11.Picture.LoadFromFile('фотокарточки\praktikani\фонфиолетовый.bmp');
...
begin
  Image12.visible:=True;
    Image11.Picture.LoadFromFile('фотокарточки\praktikani\фонголубой.bmp');
...
begin
form5.Cursor:=1;
image1.Picture.LoadFromFile('фотокарточки\фонннн.bmp');
image2.Picture.LoadFromFile('фотокарточки\дедок.bmp');
image3.Picture.LoadFromFile('фотокарточки\praktikani\1a.png');
image4.Picture.LoadFromFile('фотокарточки\кнопка3333.bmp');
image5.Picture.LoadFromFile('фотокарточки\praktikani\блондиa.png');
image6.Picture.LoadFromFile('фотокарточки\praktikani\4.png');
image7.Picture.LoadFromFile('фотокарточки\praktikani\киреал.png');
image8.Picture.LoadFromFile('фотокарточки\кнопка3333.bmp');
image9.Picture.LoadFromFile('фотокарточки\кнопка33332.bmp');
image10.Picture.LoadFromFile('фотокарточки\фонннн2.bmp');
image11.Picture.LoadFromFile('фотокарточки\фонннн.bmp');
image12.Picture.LoadFromFile('фотокарточки\имба кнопка.bmp');
image13.Picture.LoadFromFile('фотокарточки\кнопка3333.bmp');


Image14.Picture.LoadFromFile('фотокарточки\lampaoff.bmp');
Image15.Picture.LoadFromFile('фотокарточки\lampaon.bmp');
image1.Align:=alClient;
image14.Visible:=false;
label4.Caption:='Ќажми на персонажа, чтобы'+#13#10+'узнать про него больше';
label5.Caption:= '„тобы убрать подсказку,'+#13#10+'кликни на лампу снова'
end;
