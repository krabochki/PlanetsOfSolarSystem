...
x:=1;
form3.Cursor:=1;
image17.Picture.LoadFromFile('фотокарточки/тише едешь дальше будешь.bmp');
image17.Align:=alclient;
image17.Stretch:=true;
Image1.align:=alClient;
image18.align:=alclient;
image1.Picture.LoadFromFile('фотокарточки/pixel-art-wallpaper-20072219574552048x1152.jpg');
image2.Picture.LoadFromFile('фотокарточки/подарок1.bmp');
image3.Picture.LoadFromFile('фотокарточки/кнопкаa.bmp');
image4.Picture.LoadFromFile('фотокарточки/кнопка2a.bmp');
image5.Picture.LoadFromFile('фотокарточки/ракета.bmp');
image6.Picture.LoadFromFile('фотокарточки/ufoа.bmp');
image7.Picture.LoadFromFile('фотокарточки/космонавтр.bmp');
image9.Picture.LoadFromFile('фотокарточки/венера.bmp');
image10.Picture.LoadFromFile('фотокарточки/фреде меркуре.bmp');
image11.Picture.LoadFromFile('фотокарточки/земля.bmp');
image12.Picture.LoadFromFile('фотокарточки/марс.bmp');
image14.Picture.LoadFromFile('фотокарточки/замок.bmp');
image15.Picture.LoadFromFile('фотокарточки/замок.bmp');
image16.Picture.LoadFromFile('фотокарточки/замок.bmp');
image18.Picture.LoadFromFile('фотокарточки/нормик.bmp');
image13.Picture.LoadFromFile('фотокарточки/кнопка55.bmp');
image8.Picture.LoadFromFile('фотокарточки/парад планетА.bmp');
image19.Picture.LoadFromFile('фотокарточки/кнопуля.bmp');
...
image4.Enabled:=true;
image3.Enabled:=true;
image3.Picture.LoadFromFile('фотокарточки/кнопка.bmp');
image4.Picture.LoadFromFile('фотокарточки/кнопка2.bmp');
image8.Picture.LoadFromFile('фотокарточки/парад планет.bmp');
image6.Picture.LoadFromFile('фотокарточки/ufo.bmp');
image2.Picture.LoadFromFile('фотокарточки/подарок.bmp');
...
x:=x+1;
image21.Picture.LoadFromFile('фотокарточки/door.png');
end;
