...
GIF.LoadFromFile ('фотокарточки\форма инопланетяне\fff.gif');
GIF.Animate:=True;
...
form12.Close;  //закрытие вместе с этой формой дополнительно 12ую, фона к полю Memo1
...
aliens.Cursor:=1;
  n:=1;
  memo1.Lines.loadfromfile('текст\Введение.txt');
  ...
  SendMessage(Memo1.Handle, EM_GETRECT, 0, LongInt(@Rect)); //расширение отступов в поле Memo1
  Rect.Left:= 20;
  Rect.Top:= 20;
...
if n=1 then
  begin
    memo1.Lines.loadfromfile('текст\Введение.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок1.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема.png');
  end;
if n=2 then
  begin
    memo1.Lines.loadfromfile('текст\Вернемся к истокам прошлого.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок2.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема2.png');
  end;
if n=3 then
  begin
    memo1.Lines.loadfromfile('текст\А зачем нам это.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок3.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема3.png');
  end;
if n=4 then
  begin
    memo1.Lines.loadfromfile('текст\Признаки.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок4.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема4.png');
  end;
if n=5 then
  begin
    memo1.Lines.loadfromfile('текст\Аргументы против.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок5.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема5.png');
  end;
if n=6 then
  begin
    memo1.Lines.loadfromfile('текст\Почему.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок6.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема6.png');
  end;
  if n=7 then
  begin
    memo1.Lines.loadfromfile('текст\Послания.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок7.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема7.png');
  end;
  if n=8 then
  begin
    memo1.Lines.loadfromfile('текст\Люди.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок8.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема8.png');
  end;
  if n=9 then
  begin
    memo1.Lines.loadfromfile('текст\Неужели.txt');
    image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок9.png');
    image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема9.png');
  end;
end;
...
memo1.Lines.loadfromfile('текст\Введение.txt');
image3.Picture.LoadFromFile('фотокарточки\форма инопланетяне\тема.png');
image2.Picture.LoadFromFile('фотокарточки\форма инопланетяне\заголовок.png');
end;
