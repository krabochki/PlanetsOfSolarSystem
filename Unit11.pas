...
begin
if unit16.number=1 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\1c.jpg');
if unit16.number=2 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\2c.jpg');
if unit16.number=3 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\3c.jpg');
if unit16.number=4 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\4c.jpg');
if unit16.number=5 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\5c.jpg');
if unit16.number=6 then open.LoadFromFile('фотокарточки\ПАЗЗЛ\6c.jpg');
...
begin
  ...
  Timer1.Enabled:=false;
   ...
   ShowMessage('Поздравляю! Ты собрал паззл! Твой счёт: '+inttostr(score));
   alienspuzzle.Close;
